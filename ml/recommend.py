...
def recommend_best_time(
    ...
    average_focus = result.average_focus

    # 0–9 sessions → Global historical data
    if session_count < 10:
        ...
        return {
            ...
            "reason": "Not enough personal session data yet. Recommendation is based on the most productive historical time across users."
        }

    # 10–29 sessions → User historical data
